  ...
  if (success) {
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center">
        ...
        <p className="text-sm text-gray-500 mb-6">Ton compte est cree. Toutes les fonctionnalites sont disponibles.</p>
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" required value={formData.firstName} onChange={(e) => setFormData({ ...formData, firstName: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:border-gray-400 outline-none text-sm" placeholder="Prenom" />
              </div>
              <div>
      ...
      <p className="text-center text-xs text-gray-400 mt-6">
        En creant un compte, tu acceptes nos <Link href="/mentions-legales" className="underline">conditions</Link> et notre <Link href="/confidentialite" className="underline">politique de confidentialite</Link>.
      </p>
    </div>
  )
}
